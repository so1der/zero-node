...
Therefore, there are two firmware in the [firmware folder](/firmware/):
...
Тому в [директорії firmware](/firmware/) присутні дві прошивки:
